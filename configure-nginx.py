...
print('Writing default content to /etc/nginx/sites-enabled/edit-reverse-proxy.conf...')
...
print('Writing default content to /etc/nginx/nginx.conf...')
...
print('Writing default content to /etc/nginx/sites-enabled/default...')
